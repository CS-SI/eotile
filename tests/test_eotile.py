...
from eotile.eotiles.get_bb_from_tile_id import tile_id_matcher, get_tiles_from_tile_id
...
class TestEOTile(unittest.TestCase):
    ...
    def test_get_tiles_from_tile_id(self):
        output_s2, output_l8, output_srtm, output_cop = \
            get_tiles_from_tile_id("31TCJ", Path(
                "eotile/data/aux_data"
            ), False, False, srtm=True, cop=True)
    ...
    def test_main_module(self):
        output_s2, output_l8, output_srtm, output_cop = \
            eomain("-74.657, 39.4284, -72.0429, 41.2409", s2_only=False, l8_only=False, srtm=True, cop=True)
    ...
    def test_main_module(self):
        output_s2, output_l8, output_srtm, output_cop = \
            eomain("tests/test_data/illinois.shp", s2_only=False, l8_only=False, srtm=True, cop=True)
